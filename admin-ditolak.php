...
$ajuans = mysqli_query($conn, "SELECT * FROM data WHERE status='tolak'");
$jumlah_ditolak = 0;
...
<body>
    <halaman value="admin-ditolak"></halaman>
    <?php require 'navigasi.php'; ?>

    <h1>Status Ditolak</h1>
    <?php if ($jumlah_ditolak == 0) { echo "<h2 class='not-data-found'>Tidak ada data</h2>"; } ?>
