...
$ajuans = mysqli_query($conn, "SELECT * FROM data WHERE status='terima'");
$jumlah_diterima = 0;
...
<body>
    <halaman value="admin-diterima"></halaman>
    <?php require 'navigasi.php'; ?>

    <h1>Status Diterima</h1>
    <?php if ($jumlah_diterima == 0) { echo "<h2 class='not-data-found'>Tidak ada data</h2>"; } ?>
